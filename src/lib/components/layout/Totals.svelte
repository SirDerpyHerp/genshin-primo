<script lang='ts'>
    ...
    import { source_state } from "../../store/source_state";
    import { assumed_last_minor_ver, min_ver, base_version_start, base_ver } from "$lib/data/version_start";
    ...
    function calculate(state: InputState) {
        ...
        totalPulls = Math.floor(totalPrimos/160) + state.pulls
